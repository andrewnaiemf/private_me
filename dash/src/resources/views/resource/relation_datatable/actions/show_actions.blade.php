    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url(app('dash')['DASHBOARD_PATH'].'/resource/'.$resourceName.'/action') }}" method="post">
          ...
          <div class="text-center actionbtn{{ $resourceName }}">
...
<div class="row actions_{{ $resourceName }}">
  <div class="col-8">
    <select name="action{{ $resourceName }}" class="action{{ $resourceName }} form-select form-select-md">
  ...
  <div class="col-2">
    <button type="button" class="DoAction{{ $resourceName }} btn btn-info btn-md"><i class="fa fa-play"></i></button>
  </div>
</div>
