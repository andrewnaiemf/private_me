...
class Advertisements extends Resource {
	 ...
	 */
	public static $group = 'Advertisements';
	 ...
	 * @param static property string
	 */
	public static $icon = '<i class="fas fa-ad"></i>'; // put <i> tag or icon name
